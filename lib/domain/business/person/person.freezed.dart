...
class _$PersonTearOff {
  ...
  _Person call({String? id, required String name, Phone? phone}) {
    return _Person(
      id: id,
      name: name,
      phone: phone,
...
abstract class $PersonCopyWith<$Res> {
  ...
  $Res call({String? id, String name, Phone? phone});
}
...
class _$_Person implements _Person {
  const _$_Person({this.id, required this.name, this.phone});
...
abstract class _Person implements Person {
  const factory _Person({String? id, required String name, Phone? phone}) =
      _$_Person;

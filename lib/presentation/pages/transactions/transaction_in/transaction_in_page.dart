...
class TransactionInPage extends StatelessWidget {
  TransactionInPage({
    Key? key
  }) : super(key: key);
  ...
  Widget buildEmpty(BuildContext context) {
    return EmptyData(
      ...
      image: AssetImage('assets/images/empty_transaction_in.png'),
      title: 'Belum Ada Barang Masuk',
      description: 'Ketuk "Tambah Barang Masuk" untuk menambahkan Transaksi Barang Masuk.',
      buttonText: 'Tambah Barang Masuk',
      onTapButton: () {
        final categories = context.read<GoodsBloc>().state.failureOrMasterCategories.fold(
          (l) => KtList<GoodsCategory>.empty(),
          (r) => r
        );
        mRouter(context, RouterNavigation.navigate(TransactionInFormRoute(categories: categories)));
      },
      onRefresh: () async {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<TransactionInBloc, TransactionInState>(
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                onTap: () {
                                  mRouter(context, RouterNavigation.navigate(TransactionInDetailRoute(transaction: transaction)));
                                },
                              );
                            },
                          ),
                            ...
                            child: Container(
                              ...
                              child: TextButton(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text('Tambah Barang Masuk', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16.0)),
                                  ),
                                ),
                              ),
                            ),
